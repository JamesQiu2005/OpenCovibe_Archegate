...
<head>
  ...
  <meta name="generator" content="ArcheCovibe">
  <title>${title} — ArcheCovibe</title>
  <style>
${styles}
/* Export overrides */
...
<body class="bg-background text-foreground">
  ...
  <footer style="max-width:48rem;margin:0 auto;padding:1.5rem;text-align:center;font-size:0.75rem;color:hsl(var(--muted-foreground))">
    Generated by <a href="https://github.com/JamesQiu2005/OpenCovibe_Archegate" style="color:hsl(var(--primary))">ArcheCovibe</a>
  </footer>
  <script>
